...
function  AddSubject ({history, location})  {
  ...
  useEffect(() => {
    ...
    axios.get('https://schedule-service-alatoo.herokuapp.com/subjects')
        ...
        axios.get(`https://schedule-service-alatoo.herokuapp.com/schedules/${location.state.id}`, {
                    headers: {
                      ...
                      console.log(res.data, 'From edit page')
  ...
  const onClickTime = (id) => {
   ...
   const handleSubmit = e => {
       ...
       axios.put(`https://schedule-service-alatoo.herokuapp.com/schedules/${schedule.id}`, data, {
            headers: {   
                "Access-Control-Allow-Origin": "*",
                 "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS"            
              }})  
    ...
    <InputLabel id="demo-mutiple-name-label">Cabinet</InputLabel>
      ...
      <Button type="submit" fullWidth variant="contained" color="primary" >Edit chedule </Button>
                    </form>
                </div>
             </div>
        )
